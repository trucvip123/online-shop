...
class UserInfo(models.Model):
    ...
    uanswer = models.CharField(
        max_length=30, default="", verbose_name="security_answer"
    )
    uquestion = models.CharField(
        max_length=40, default="", verbose_name="security_question"
    )
...
class GoodsBrowser(models.Model):
    ...
    good = models.ForeignKey(
        GoodsInfo, on_delete=models.CASCADE, verbose_name="goods_ID"
    )
    browser_time = models.DateTimeField(
        default=datetime.now, verbose_name="browse_item"
    )
